...
(:derived
  ...
  (> (fuel ?a) (* (distance ?c1 ?c2) (fast-speed ?a)))
)
  ...
  (:derived
    ...
    (:derived
      ...
      (:derived
        ...
        (consumo-lento ?a - aircraft ?c1 - city ?c2 - city)
        (* (distance ?c1 ?c2) (slow-burn ?a))
      )
        (:derived

          (consumo-rapido ?a - aircraft ?c1 - city ?c2 - city)
...
(:task transport-person
  ...
  (:method Case1 ; si la persona est� en la ciudad no se hace nada
   ...
   (:method Case2 ;si no est� en la ciudad destino, pero avion y persona est�n en la misma ciudad
    ...
    (:method Case3 ;si no est� en la ciudad destino,  avion y persona est�n en distintas ciudades
         	  :precondition (and (at ?p - person ?c1 - city)
