...
FrontierExplorer::FrontierExplorer()
{
   ...
   //Publicador de los nodos de frontera para visuoalizarlos en rviz
	...
	//Se subscribe a la posición estimada por amcl
    odomSub =  node.subscribe("amcl_pose", 100, &FrontierExplorer::odomCallBack, this);
...
void FrontierExplorer::odomCallBack(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& msg)
{
